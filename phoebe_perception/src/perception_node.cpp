...
int main(int argc, char *argv[])
{
  ...
  world_frame = priv_nh_.param<std::string>("world_frame", "base_link");
  ...
  z_filter_max = priv_nh_.param<float>("z_filter_max",  6.5);
...
//               ros::topic::waitForMessage<sensor_msgs::PointCloud2>(topic, nh);
  ...
  * ========================================*/
  ...
  pcl::toROSMsg( *(clusters.at(0)) , *pc2_cloud);  //  zf_cloud    *(clusters.at(0))   *cloud_f
