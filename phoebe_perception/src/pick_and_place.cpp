...
void openGripper(trajectory_msgs::JointTrajectory& posture)
{
  ...
  posture.joint_names[0] = "right_arm_gripper_joint";
 // posture.joint_names[1] = "right_arm_gripper_joint2";

  /* Set them as open, wide enough for the object to fit. */
  posture.points.resize(1);
  posture.points[0].positions.resize(1);
  posture.points[0].positions[0] = -0.0075;
...
void closedGripper(trajectory_msgs::JointTrajectory& posture)
{
 ...
 // posture.joint_names[1] = "right_arm_gripper_joint2";
  ...
  posture.points.resize(1);
  posture.points[0].positions.resize(1);
  posture.points[0].positions[0] = 0.004;
...
void pick(moveit::planning_interface::MoveGroupInterface& move_group)
{
  ...
  orientation.setRPY(-1.57, 0.0, -1.57);
  grasps[0].grasp_pose.pose.orientation = tf2::toMsg(orientation);
  grasps[0].grasp_pose.pose.position.x = 0.55;
  grasps[0].grasp_pose.pose.position.y = -0.16;
  grasps[0].grasp_pose.pose.position.z = 0.72;
...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface& planning_scene_interface)
{
  ...
  collision_objects[1].primitives[0].dimensions[2] = 0.6;
  ...
  collision_objects[2].primitive_poses[0].position.x = 0.55;
  collision_objects[2].primitive_poses[0].position.y = -0.18;
  collision_objects[2].primitive_poses[0].position.z = 0.720;
  // END_SUB_TUTORIAL
...
int main(int argc, char** argv)
{
  ...
  ROS_INFO_STREAM("EndEffectorName " << group.getEndEffectorLink() << " ." );
